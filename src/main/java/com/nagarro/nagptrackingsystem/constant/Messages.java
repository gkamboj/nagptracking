...
public class Messages {
	...
	public static String REGISTER_EMAIL_SUCCESS = "Email with registration details sent successfully";
	public static String REGISTER_SUCESS = "You have been registered for the NAGP. Your login details are as following: \n";
